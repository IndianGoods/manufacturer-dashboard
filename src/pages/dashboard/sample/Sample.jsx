...
const Samples = () => {
  ...
  const breadcrumbItems = [{ name: "Sample Orders" }];

  // Filter to show sample orders - we'll use the filtered items from Redux store
  // but show all orders in the samples page since this is a sample order management system
  // In a real app, you might have a separate sample order type or flag in the database
  ...
  const tabs = [
    ...
    },
    {
      id: "shipped",
      name: "Shipped",
      count: items.filter((o) => o.status === "shipped").length,
    },
  ];
  ...
  const handleRowClick = (order, e) => {
    ...
    console.log(
      "Row clicked for sample order:",
      order.orderNumber,
      "Target:",
      e.target
    );
    // Navigate to sample order details page when clicking on order row
    navigate(`/dashboard/samples/${order.id}`);
  };
    ...
    <div className="text-center py-12">
      <div className="mx-auto max-w-md">
        ...
        <p className="text-gray-500 mb-6">
          Start by creating sample orders for potential customers to test your products
        </p>
      ...
      <Table>
        <Table.Header>
          <Table.Row>
            ...
            <Table.Head className="text-xs">Sample Order</Table.Head>
            <Table.Head className="text-xs">Customer</Table.Head>
            <Table.Head className="text-xs">Items</Table.Head>
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Are you sure you want to delete {selectedOrders.length} sample order
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Manage and track all sample requests for bulk orders</p>
            </div>
          </div>
                ...
                {selectedOrders.length > 0 ? (
                  ...
                  <div className="flex items-center space-x-3">
                    <span className="text-sm text-gray-700">
                      {selectedOrders.length} sample order
