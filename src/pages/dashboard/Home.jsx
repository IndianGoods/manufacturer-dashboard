      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-6 mb-8">
          {summaryCards.map((card, idx) => (
            <div
              key={card.title}
              className="flex-1 min-w-[180px] bg-white rounded-xl px-6 py-5 shadow border border-gray-100 flex flex-col justify-center items-start"
            >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow border border-gray-100 p-6 mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="px-4 py-2 bg-gray-100 rounded text-gray-700 text-xs font-normal border border-gray-200">
                  Download PDF
                </button>
              </div>
            ...
            <div className="bg-white rounded-xl shadow border border-gray-100 p-0">
              <div className="flex gap-6 px-6 pt-6 mb-4">
                <button className="text-sm font-medium text-primary-700 border-b-2 border-primary-700 pb-1">
                  Checkout
                </button>
                <button className="text-sm font-medium text-gray-400 pb-1">
                  On Process
                </button>
                <button className="text-sm font-medium text-gray-400 pb-1">
                  On Delivery
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-white rounded-xl shadow border border-gray-100 p-6">
              ...
              <div className="text-xl font-normal text-gray-900 mb-1">
                43,292 <span className="text-xs text-green-600">+2.4%</span>
              </div>
              {/* Simple Chart Placeholder (removed if not functional) */}
